    ...
    return (
        <div className='my-20'>
            <div className='text-center'>
                ...
                <img src={img} alt="" className='rounded-full h-[500px] w-[500px] text-center mx-auto my-3 border-black border-solid border-4' />
            </div>
            <p>
            ...
            <div className='flex sm:justify-center md:justify-start items-center mt-2 gap-2'>
